...
def write_cif(cell_params,atoms,spacegroup,foutname,symmetry):
...
if len(sys.argv)==2:
    ...
    try:
        ...
        print('\nError encountered with input arguments.\n')
        print('Argument(s) provided:\n')
        print(sys.argv[1:])
...
with open(filename,'r') as fin:
    ...
    if readuntil(fin,'CONVERGENCE TESTS SATISFIED'):
        ...
        if spacegroup !=1:
            ...
            write_cif(cell_params,atoms,spacegroup,foutname1,True)
            print('.cif file with symmetry {} has been generated'.format(
                rspacegroups[spacegroup]))

        foutname2=sys.argv[1]+'-P1.cif'
        write_cif(cell_params,atoms,spacegroup,foutname2,False)

        print('.cif file with symmetry P1 has been generated')
